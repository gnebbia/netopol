# -*- coding: utf-8 -*-
#
# netopol documentation build configuration file, created by
...
project = u'netopol'
copyright = u'2020, Giuseppe Nebbione'
...
latex_documents = [
  ('index', 'netopol.tex', u'netopol Documentation',
   u'Giuseppe Nebbione', 'manual'),
]
...
man_pages = [
    ('index', 'netopol', u'netopol Documentation',
     [u'Giuseppe Nebbione'], 1)
]
